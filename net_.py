...
class TransPoseNet:
    ...
    @torch.no_grad()
    def forward_offline(self, model, imu):
        r"""
        Offline forward.
        ...
        """
        _, _, global_reduced_pose, contact_probability, velocity, _ = model.forward(imu)
    ...
    @torch.no_grad()
    def forward_online(self, model, x):
        r"""
        Online forward.
        ...
        _, _, global_reduced_pose, contact_probability, velocity, self.rnn_state = model.forward(imu, self.rnn_state)
